...
CUSTOM_FILE_CAPTION = environ.get("CUSTOM_FILE_CAPTION", '<b>⎙ ꜰɪʟᴇ ɴᴀᴍᴇ :</b> <code>CK|{file_name}</code> /n/n <b>〠ꜰɪʟᴇ ꜱɪᴢᴇ :</b> <code>{file_size}</code> /n/n <b>⌾ ᴘᴏᴡᴇʀᴇᴅ ʙʏ : </b><a href='https://t.me/AM_FILMS'>@ᴀᴍ_ꜰɪʟᴍꜱ</a>  </b>')
