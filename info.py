...
CUSTOM_FILE_CAPTION = environ.get("CUSTOM_FILE_CAPTION", '''<b>⎙ ꜰɪʟᴇ ɴᴀᴍᴇ :</b> {file_name} /n/n <b>〠ꜰɪʟᴇ ꜱɪᴢᴇ :</b> {file_size} /n/n <b>⌾ ᴘᴏᴡᴇʀᴇᴅ ʙʏ : </b><a href='https://t.me/AM_FILMS'>@ᴀᴍ_ꜰɪʟᴍꜱ</a>  </b>''')
BATCH_FILE_CAPTION = environ.get("BATCH_FILE_CAPTION", '')
IMDB_TEMPLATE = environ.get("IMDB_TEMPLATE", '''⌾ ᴛɪᴛʟᴇ : {title} /n⌾ ɢᴇɴʀᴇꜱ : {genres} /n⌾ ʀᴀᴛɪɴɢ : {rating} /n⌾ ʟᴀɴɢᴜᴀɢᴇ : {languages} /n⌾ ʀᴜɴ ᴛɪᴍᴇ : {runtime} /n⌾ ʀᴇʟᴇᴀꜱᴇ ɪɴꜰᴏ : {year} /n⌾ ᴄᴇɴᴛᴜʀɪᴇꜱ : {countries}, /n/n⌾ ᴘᴏᴡᴇʀᴇᴅ ʙʏ : <a href='https://t.me/AM_ FILMS'>@ᴀᴍ_ꜰɪʟᴍꜱ</a>  </b>''')
